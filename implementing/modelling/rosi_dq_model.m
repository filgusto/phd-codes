...
dq_gen3base_j1 = DualQuaternion.transform(qo_gen3base_j1, t_gen3base_j1, 'trfirst');
...
dq_j6_j7 = DualQuaternion.transform(qo_j6_j7, t_j6_j7, 'trfirst');
...
dq_j7_tcp = DualQuaternion.transform(qo_j7_tcp, t_j7_tcp, 'trfirst');
